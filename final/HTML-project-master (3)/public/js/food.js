...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function openCheckoutModal() {
        ...
        const paymentSection = checkoutModal.querySelector('#paymentSection');
    ...
    async function handleCheckout() {
        const paymentMethod = checkoutModal.querySelector('#paymentMethod').value;
        ...
        try {
            const response = await fetch('/api/food/orders', {
                ...
                body: JSON.stringify({ items, total_amount, payment_method: paymentMethod })
            });
            if (response.ok) {
